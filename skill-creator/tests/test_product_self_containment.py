...
points at a dev-only dir" discipline enforced only here, in the dev-only pytest
suite (the release gate runs pytest anyway).
...
def test_product_layout_is_slim():
    """SKILL.md is the sole product entry doc at the artifact root
    (no product AGENTS.md/INSTALL.md) alongside README.md."""
