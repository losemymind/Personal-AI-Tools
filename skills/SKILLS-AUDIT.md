...
| 经 skill-creator 生成流程 | 7 ✅（3 自建 + 4 上游导入均合规） |
...
| ue-editor-lifecycle | `skills/development/ue-editor-lifecycle/SKILL.md` | development | safe | self | 自建（本仓库沉淀）；对比最近邻 `unreal-engine-cpp-pro`（aas，0.76 vs 0.72 采纳自建） | ✅ | ✅ 合规（2026-09-15 自建；2026-09-17 规则 4 迁入 `development/`；2026-09-23 补对比记录） |
...
- （无未完成整改项：截至 2026-09-23，7 项技能均已登记数据来源并具备对比/导入记录。）